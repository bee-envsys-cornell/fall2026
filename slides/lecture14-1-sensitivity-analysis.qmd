...
```{julia}
emissions = DataFrame(XLSX.readtable(joinpath("data", "climate", "Global_Carbon_Budget_2025_v0.6-2.xlsx"), "Global Carbon Budget", first_row=22)) # read in data
...
## Impacts of Deep Uncertainty

- Are you sure about the parameter values you've chosen?
- Are you sure about the probabilities you've assigned to Monte Carlo inputs or scenarios?

We can test the extent to which these different assumptions matter using **sensitivity analyses**.
...
![Sobol Indices](figures/sobol_scipy.png){width=80%}

::: {.caption}
Source: [SciPy Documentation](https://docs.scipy.org/doc/scipy/reference/generated/scipy.stats.sobol_indices.html)
:::
