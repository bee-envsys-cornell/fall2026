...
**Monday**: Where the plume actually lands --- the footprint on the ground, a vertical section that makes the reflection visible, and what happens when several stacks share an airshed.

**Wednesday**: Model validation. How we decide whether to believe any of this.

## Assessments

**Homework 4**: Assigned today, due Thursday, October 8.

**Mini-Project 1**: Also due Thursday, October 8.
