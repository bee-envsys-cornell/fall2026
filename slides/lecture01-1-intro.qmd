...
<https://envsys.viveks.me/fall2025/>
...
- Due by **9:00pm** the day after the lab day, will drop one.
...
- 5-6 in total, due two weeks after assignment.
...
- 5750 students are required to submit a 1--2 page discussion summarizing reading, providing thoughts, and connecting to class material.
- 4750 students can improve participation by posting about readings on Ed.

## Prelims

- Two in-class prelims (10/08, 11/12);
...
Dan searches the internet for relevant code and copy-pastes it into his Jupyter notebook.  They cite the source of the codes.
...
**Wednesday**: Lab 1: Julia and GitHub setup.

- Lab 1 link is available on Ed. Click it to accept the lab before class.
- Follow setup instructions on website.
