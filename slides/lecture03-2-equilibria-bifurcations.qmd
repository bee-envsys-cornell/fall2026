...
\frac{dL}{dt} &= L_t (H_t b_L)_{\substack{\text{impact of} \\ \text{hares}}}) - \underbrace{L_t m_L}__{\substack{\text{mortality} \\ \text{rate}}})
\end{align*}
$$
...
:::
::: {.column width=60%}
![Initial Conditions Diagram](figures/state-plot.png)
:::
::::
