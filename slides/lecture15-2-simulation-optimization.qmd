...
phist = histogram(rand(lnorm, 10_000), legend=:false, grid=:false, tickfontsize=16, guidefontsize=16, left_margin=5mm, bottom_margin=10mm) 
plot!(size=(1000, 400))
ylabel!("Count")
...
**Example**: @Quinn2017-vn uses $$a_t = \min\left(\max\left(\sum_j w_j \left| \frac{X_t - c_j}{r_j}\right|^3, 0.01\right), 0.1\right).$$
