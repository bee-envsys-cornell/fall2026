...
Can count number of "negatives" to see whether the loop is amplifying or dampening.
:::
...
In the Neoproterozoic Era (550-1000 million years ago), the Earth was covered by ice and snow during two global glaciation events. One theory is "Snowball Earth" melted due to a combination of a one-off increase in CO$_2$ (due to volcanic outgassing) and the ice-albedo feedback.

A simple climate model (with no sustained CO$_2$) with the ice-albedo feedback can be written as
...
- $A=221.2\ \text{W}/\text{m}^2$: remaining constant term for outgoing radiation (based on a stable pre-industrial temperature of 14°C).
