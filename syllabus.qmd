---
title: "Syllabus"
pdf-title: "Environmental Systems Analysis"
pdf-subtitle: "BEE 4750/5750 • Fall 2026"
pdf-note: |
  The full versions of the course syllabus, schedule, and all course materials are available online at #link("https://envsys.viveks.me/fall2026/"). This is only a partially complete, static version.
pdf-header-left: BEE 4750/5750
pdf-header-right: Fall 2026
pdf-footer-left: Environmental Systems Analysis
format:
  html: default
  typst:
    output-file: "syllabus-BEE4750-FA26.pdf"
    include-in-header: 
      - "_assets/typst-pdf/include-in-header.typ"
    include-before-body:
      - "_assets/typst-pdf/note.typ"
  docx:
    output-file: "syllabus-BEE4750-FA26.docx"
    toc: true
    toc-depth: 2
    number-sections: false
    title: "Environmental Systems Analysis"
    subtitle: "BEE 4750/5750 • Fall 2026"
engine: julia
format-links:      
  - format: typst
    text: PDF
...
- {{< fa sharp door-open title="Office Hours" >}}[TuW 1-2]{.ms-1}
:::
...
- {{< fa sharp door-open title="Office Hours" >}}[{{< var TA.office_hours >}}]{.ms-1}
::::
...
* identify feedbacks and quantify the stability of systems;
...
This course meets MW from 2:55-4:10pm in 105 Riley-Robb. In addition to the class meetings (a total of 27 lectures, 75 minutes each), the final project will be due during the university finals period. Students can expect to devote, on average, 6 hours of effort during the exam period.
...
Some notes on assignment and grading logistics:
  ...
  * Homework assignments will be distributed as GitHub repositories that you will fork and clone. While GitHub use is not required for the class aside from forking and cloning assignments, students are encouraged to update their GitHub repositories as they work on the assignments; this helps with answering questions, keeping solutions synced across groups, and gives you a backstop in case something goes wrong and you can't submit your assignment on time.
  ...
  * One homework assignment will be dropped by default for students in BEE 4750 (but not for students in BEE 5750). You can turn in assignments within 24 hours of the due date with a 50% penalty. If you need a further accomodation for a particular assignment, talk to Prof. Srikrishnan ***before the due date.*** Requests for extensions made after the due date will only be considered under extraordinary and unexpected circumstances. **Technical challenges submitting assignments are not acceptable reasons for extensions to be granted**, and late penalties will apply.
...
There will be 2 more in-depth computational projects, each worth 10% of the final grade, assigned throughout the semester which will require students to apply multiple methods from the course to a particular systems problem. These projects will typically involve the formulation and analysis of a mathematical model for the system of question and will involve the preparation of a short report justifying the model formulation, outlining the methods, and presenting and interpreting results, but the problems will be more open ended than those the homework assignments. Students in BEE 4750 will be able to work in groups of 2 and should submit a group report following the homework guidelines, while students in BEE 5750 must work independently.
...
The term project will be due during the university finals period, at a date and time assigned by the Office of the University Registrar. In addition to work completed during the semester, students can expect to devote approximately 6 hours to the term project during the exam period.
