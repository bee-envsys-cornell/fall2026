...
1. ***Group*** (80 points):
   ...
   3. (20 points) **Presentation**: Groups will present their projects to the class at the end of the semester. Due to time restrictions, these may be recorded and uploaded to Canvas if there are too many projects for the time available. Presentations should be no more than 10 minutes long and should be aimed at a general audience. 
   4. (5 points) **Presentation Peer Review**: Each group will be asked to provide a peer review on two of their classmates' presentations. The format for the review will be made available on the class website.
