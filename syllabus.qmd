...
- {{< fa sharp door-open title="Office Hours" >}}[M 1-2, T 4-5]{.ms-1}
:::

::: {.column width="30%"}
### TA

- {{< fa sharp user title="Name" >}} [Samantha Davies]{.ms-1}
- {{< fa sharp envelope title="Email" >}} [[sld238@cornell.edu](mailto:sld238@cornell.edu)]{.ms-1}
- {{< fa sharp building title="Office" >}} [217 Riley-Robb Hall]{.ms-2}
- {{< fa sharp door-open title="Office Hours" >}}[MW 4:15-5:15]{.ms-1}
::::
...
| Category | Weight |
|:--------|:------:|
| Participation (4750) | 10% |
| Reading Assignments (5750) | 10% |
| Exercises | 10% |
| Labs | 10% |
| Homework | 15% |
| Prelims | 30% |
...
We will provide topical readings throughout the semester; these will typically be drawn from textbooks or journal articles. These readings are optional (but may be interesting) for students enrolled in BEE 4750. Students enrolled in BEE 5750 will be required to submit 1-2 page discussions of these readings, including:

* Summaries of the key questions, hypotheses, methods, and insights of the paper;
* Discussion of the connection(s) between the reading and our in-class content (lectures, discussions, etc.); these can be substantive or methodological.

Discussions are due before class the Monday after the week they're assigned. Each discussion will be graded on a scale of 0-3. Your discussion should make specific references to the paper and your personal takeaways and insights from the reading. Submissions which lack these specifics will not receive much credit. 

While discussions are not required for students enrolled in 4750, doing the readings and posting your thoughts on Ed Discussion is a good way to improve your participation grade.

### Exercises

Most weeks will involve a short problem set aimed at assessing key concepts. We will use Gradescope for these exercises. These will be released Monday at the end of class and are due before class (2:55PM) the following Monday. The exercises will be multiple choice or similar (categorization, multiple answer, etc), automatically graded, and you can submit them as often as you like. It is highly recommended that you do these promptly and take them seriously, as concepts and simple code practice will be useful for the homeworks and midterm exams. We will automatically drop one exercise set, but no late exercises will be accepted.
