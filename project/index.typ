...
= Schedule
<schedule>
Milestones which are only for BEE 5750 or 4750 students are in #emph[italics].

#table(
  columns: (20%, 5%, 5%, 5%, 10%),
  align: (center,center,center,left,center,),
  table.header([Milestone], [Points], [Instructions], [Due Date], [],),
  table.hline(),
  [Proposal], [10], [#link("proposal.qmd")[]], [Oct.~24, 2025], [],
  [Presentation], [20], [#link("presentation.qmd")[]], [Dec.~08, 2025], [],
  [Peer Review], [10], [#link("peer-review.qmd")[]], [Dec.~10, 2025], [],
  [Report], [40], [#link("report.qmd")[]], [Dec.~20, 2025], [],
  [Team and Self Evaluations], [20], [#link("evaluations.qmd")[]], [Dec.~20, 2025], [],
)
= Scope and Topics
<scope-and-topics>
The project can be on any environmental system of interest, so long as the approaches from class are being extended in some way. This can involve applying new methods (#emph[e.g.] multi-objective optimzation, more advanced uncertainty analysis, lifecycle analysis) to systems studied from class, or applying class or new methods to other systems.
