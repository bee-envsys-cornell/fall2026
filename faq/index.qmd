...
- Python is extremely readable, but also can be very slow unless you're using libraries which are written in C++. The `JuMP.jl` optimization package is also ideal for translating mathematical representations of optimization problems into code and is becoming a major part of analytic workflows in *e.g.* energy systems.
...
- Assignment distribution via forking GitHub repositories;
...
None from the start! And the following commands are all you will need for this course (you can also use [GitHub Desktop](https://desktop.github.com/) or use the [GitHub functionality in VS Code](https://code.visualstudio.com/docs/sourcecontrol/overview):
...
- `git pull`: This syncs your local repository with the remote repository. This is essential when working with others or across multiple machines to make sure you are editing the most recent version of the file(s).

## Assignments (Homeworks and Labs)

### How do I access assignments?

Assignments will be distributed as GitHub repositories that you fork to your own account. Links to the assignment repositories will be posted on [Ed Discussion](https://us.edstem.org) as they are released, and posts with the links for active assignments will be pinned. The class schedule will link to a page which has a preview of the assignment, but links are not provided from this page to the repository.
...
Bugs are a feature of life when you program. This [debugging manifesto](https://jvns.ca/blog/2022/12/08/a-debugging-manifesto/) has some good tips and principles to keep in mind.
...
2. Post on [Ed Discussion](https://us.edstem.org). For the most effective help, follow the following guidelines (adapted from Stack Overflow's ["How Do I Ask A Good Question?"](https://stackoverflow.com/help/how-to-ask) and Julia's ["Make It Easier To Help You"](https://discourse.julialang.org/t/please-read-make-it-easier-to-help-you/14757)):
...
Consult the options at the [tutorial](../tutorials/notebook-to-pdf.qmd).
