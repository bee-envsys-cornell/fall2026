...
* **Prelim 1**: Wednesday, October 08;
* **Prelim 2**: Monday, November 12.
...
The emphasis is on concepts; there will be no major formulas that you will need to use, and no programming. You will be potentially be asked to derive mathematical versions of models, apply or explain concepts from class, and interpret model outputs. 

In general, the same [homework grading rubric](../policies/rubric.qmd) applies to exam problems, as appropriate (*.e.g.* nothing about code). The deadly sins will still be penalized, and your solutions should be clear with transparent and well-communicated reasoning.
...
While we will not hand out sample exams, exam problems will be closer in difficulty to lab or exercise problems than the homework, since you have two weeks to solve homework problems and have full acccess to external resources, course staff, and classmates. The goal is to assess your ability to understand concepts, set up problems, determine appropriateness of methods, and interpret the output, rather than on doing computations. We cannot, and do not, expect you to solve problems with homework-level difficulty in the restricted exam setting.
